...
const NATIONAL_DOSSIER = [
  ...
  },
  {
    ...
    points: [
      ...
      "Gouvernance locale : 351 communes (dont 49 urbaines), 17 régions, 47 provinces. Le Code général des collectivités territoriales (1998, révisé 2004) transfère des compétences éducatives, sanitaires et infrastructurelles aux communes. La réforme de juillet 2025 a fait passer le pays de 13 à 17 régions avec des appellations locales : Guiriko, Bankui, Liptako, Goulmou, Djôrô, Kuilsé, Nando, Oubri, Yaadga, Nakambé, Kadiogo, Tannounyan, Nazinon, Sirba, Soum, Tapoa et Sourou.",
    ],
  },
];
