    ...
    <div className="min-h-screen pt-nav bg-blanc flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gris mt-2 text-sm">Accédez à votre espace Faso Atlas</p>
        </div>
        ...
        <p className="text-center mt-4 text-sm text-gris">
          ...
          <Link href="/register" className="text-rouge hover:underline font-medium">Créer un compte</Link>
        </p>
      </div>
    </div>
  )
